"""
Django settings for LexiconSite project.
...
SECRET_KEY = 'django-insecure-9jm_9l6&k5y9*@h3r(p$)dun_2=e!b3su$*k9_f!o!9x3(j$j%'
...
WSGI_APPLICATION = 'LexiconSite.wsgi.application'
# Database
